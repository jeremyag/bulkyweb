...
public class OrderController : Controller
{
    ...
    {
        var orderHeaderFromDb = _unitOfWork.OrderHeaders.Get(u => u.Id == OrderVM.OrderHeader.Id);
    ...
    {
        OrderVM.OrderHeader = _unitOfWork.OrderHeaders
    ...
    {
        var orderHeader = _unitOfWork.OrderHeaders.Get(u => u.Id == orderHeaderId, includeProperties: "ApplicationUser");
        if (orderHeader.PaymentStatus == SD.PaymentStatusDelayedPayment)
        {
    ...
    public IActionResult GetAll(string status)
    {
        ...
        {
            orderHeaders = _unitOfWork.OrderHeaders.GetAll(includeProperties: "ApplicationUser").ToList();
        }
        else
        {
